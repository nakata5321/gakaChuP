...
class HashController:
    ...
    def calcHashScore(self):
        ...
        for i in range(0, self.__hashFieldTable.size):
            self.__hashFieldTable['Cost'][i] = self.__hashTree[self.__tagPopularity.loc[i][0]]

        self.__hashFieldTable['Score'] = self.__CC*self.__hashFieldTable['Number of Posts'] + self.__IC*self.__hashFieldTable['Cost']
